...
class SettingsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      body: SafeArea(
        child: ListView(
          padding: const EdgeInsets.fromLTRB(12, 12, 20, 40),
          children: [
            Align(
              ...
              child: Column(
                children: [
                  ...
                  _ChoiceTile(
                    ...
                    title: 'Langue',
                    value: settings.language.labelFr,
                  ...
                  SwitchListTile.adaptive(
                    ...
                    subtitle: Text('Agrandit tous les textes', style: TextStyle(fontSize: 12, color: AppColors.textMutedOf(context))),
                  ...
                  SwitchListTile.adaptive(
                    ...
                    subtitle: Text('Contraste renforcé pour le plein soleil', style: TextStyle(fontSize: 12, color: AppColors.textMutedOf(context))),
          ...
          children: [
            ...
            for (final lang in AppLanguage.values)
              ListTile(
                ...
                title: Text('${lang.labelFr} · ${lang.endonym}'),
                onTap: () {
      ...
      children: [
        ...
        ListTile(
          onTap: () async {
            ...
            if (confirmed == true) {
              try {
                // Show a simple snackbar to indicate start
                if (context.mounted) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text('Suppression du cache en cours…'),
                ...
                if (context.mounted) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text('Cache carte supprimé avec succès'),
          ...
          title: const Text('Supprimer le cache carte',
              style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
          subtitle: Text('Libérer de l\'espace sur votre téléphone',
              style: TextStyle(color: AppColors.textMutedOf(context), fontSize: 12)),
