...
final agroRulesRemoteSourceProvider = Provider<AgroRulesRemoteSource>((ref) {
  ...
  final AgroRulesRemoteSource baseSource;
  if (dio == null) {
    baseSource = const LocalAgroRulesRemoteSource();
  } else {
    baseSource = HttpAgroRulesRemoteSource(dio.instance);
  }
  return HotPatchRulesRemoteSource(baseSource);
});
