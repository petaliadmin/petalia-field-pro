class AppConstants {
  ...
  static const String boxNdvi = 'box_ndvi';
  ...
  // Agronomy thresholds
  /// Pluie cumulée (mm) sur 6 h au-delà de laquelle une pulvérisation est
  /// déconseillée (risque de lessivage). Valeur validée par l'ISRA / agro Sahel.
  static const double rainLeachingThresholdMm = 5.0;
}
